...
function rpcResult(id: JsonRpcId, result: unknown): NextResponse {
  return NextResponse.json({ jsonrpc: '2.0', id: id ?? null, result });
}

function rpcError(id: JsonRpcId, code: number, message: string, data?: unknown): NextResponse {
...
async function handleInitialize(msg: JsonRpcRequest): Promise<NextResponse> {
...
function handleToolsList(msg: JsonRpcRequest): NextResponse {
  return rpcResult(msg.id ?? null, {
